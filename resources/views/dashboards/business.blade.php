        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('internships.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">+ Post New Internship</a>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    <div class="bg-purple-50 p-6 rounded-lg">
                        ...
                        <a href="{{ route('internships.index') }}" class="text-purple-600 mt-2 inline-block">Manage →</a>
                    </div>
                        ...
                        <div class="border p-4 rounded-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">{{ $internship->applications->count() }} application(s)</p>
                                    <p class="text-xs text-gray-500">{{ $internship->created_at->diffForHumans() }}</p>
                                </div>
                                <a href="{{ route('internships.show', $internship) }}" class="text-blue-600 text-sm">View →</a>
                            </div>
                        </div>
                    @empty
