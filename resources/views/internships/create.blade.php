                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('internships.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="duration" placeholder="e.g., 3 months" class="w-full border rounded-lg p-2" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Application Deadline</label>
                            <input type="text" name="deadline" placeholder="e.g., April 30, 2026" class="w-full border rounded-lg p-2" required>
                        </div>
